<template>
  <div class="content-body">
    ...
    <div id="shuiguo" style="width: 100%; height: 100%"></div>
  </div>
</template>
...
export default {
        ...
        series: [
          {
            ...
            data: [120, 132, 101, 90, 230, 210, 300, 100],
          },
          {
            name: "2018",
            type: "line",
  ...
  mounted() {
    this.initCharts(document.getElementById("shuiguo"));
  },
};
</script>
