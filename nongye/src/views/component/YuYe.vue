<template>
  <div class="content-body">
    ...
    <div id="yuye" style="width: 100%; height: 100%"></div>
  </div>
</template>
...
export default {
        ...
        series: [
          {
            ...
            data: [
              { value: 1048, name: "鱼类产量" },
              { value: 735, name: "虾蟹类产量" },
              { value: 580, name: "贝类产量" },
              { value: 484, name: "海水产品产量" },
              { value: 300, name: "淡水产品产量" },
            ],
          },
        ],
      };
  ...
  mounted() {
    this.initCharts(document.getElementById("yuye"));
  },
};
</script>
