...
class Csv(models.Model):
    ...
    森林覆盖率_field = models.FloatField(db_column='森林覆盖率(%)', blank=True, null=True)  # Field renamed to remove unsuitable characters. Field renamed because it ended with '_'.
